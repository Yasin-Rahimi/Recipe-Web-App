      ...
      <div className="flex flex-col w-1/2 p-6">
        ...
        >
          <div className="self-end p-4">
            ...
            {cat <span className="inline-flex items-center px-3 py-0.5 rounded-full text-xs font-semibold text-white bg-gradient-to-r from-yellow-500 to-yellow-500 mr-3">
              {category}
            </span>}
